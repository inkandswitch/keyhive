...
| [Keyline](./keyline/README.md)                          | The successor authority graph: delegations and revocations as a state-based CRDT, admin reach, apex semantics. With the [crate spec](./keyline/implementation.md), [patterns](./keyline/patterns.md), [alternatives](./keyline/alternatives.md), [edge cases](./keyline/edge-cases.md), and [evaluation notes](./keyline/evaluation-notes.md) |
