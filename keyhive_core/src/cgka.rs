...
impl Cgka {
    pub fn new(
        ...
        let signed_op = Signed::try_sign(init_add_op, signing_key)?;
        Cgka::new_from_init_add(doc_id, owner_id, owner_pk, signed_op)
    }
    ...
    pub fn with_new_owner(
        ...
        let mut owner_sks_with_public = owner_sks;
        owner_sks_with_public.insert(Public.share_key(), Public.share_secret_key());

        cgka.owner_id = my_id;
        cgka.owner_sks = owner_sks_with_public;
