//! A testing context that manages a set of keyhives and machinery for syncing events
//! between them.
...
///
/// This flattens libraries across the codebase into a single vocabulary for
/// tests to assert on. Everything else is wrapped as `Other`.
#[derive(Debug, Error)]
pub enum TestError {
